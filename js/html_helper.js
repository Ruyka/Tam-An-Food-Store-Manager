    ...
    var ALTER_PRODUCT_ROW=[
            ...
            '<td><input id ="alter-product%PRODUCT_ID%-bought" type="number" min="0" class="alter-product-bought form-control" sorttable_customkey ="%PRODUCT_BOUGHT%" value = "%PRODUCT_BOUGHT%"  onchange="alter_product_observe(0,\'%PRODUCT_ID%\')"></td>',
            '<td><input id ="alter-product%PRODUCT_ID%-percentage" type="number" min="0" class="alter-product-percentage form-control" sorttable_customkey ="%PRODUCT_PERCENTAGE%" value = "%PRODUCT_PERCENTAGE%" onchange="alter_product_observe(1,\'%PRODUCT_ID%\')"></td>',
            '<td><input id ="alter-product%PRODUCT_ID%-sale" type="number" min="0" class="alter-product-sale form-control" sorttable_customkey ="%PRODUCT_SALE%" value = "%PRODUCT_SALE%" onchange="alter_product_observe(2,\'%PRODUCT_ID%\')"></td>',
    ...
    var ALTER_PRODUCT_ADD_NEW_PRODUCT_ROW=[
            ...
            '<td><input id ="alter-product-no-id%PRODUCT_ID%-bought" type="number" min="0" class="alter-product-bought form-control" sorttable_customkey ="%PRODUCT_BOUGHT%" value = "%PRODUCT_BOUGHT%"  onchange="alter_add_product_observe(0,\'%PRODUCT_ID%\')"></td>',
            '<td><input id ="alter-product-no-id%PRODUCT_ID%-percentage" type="number" min="0" class="alter-product-percentage form-control" sorttable_customkey ="%PRODUCT_PERCENTAGE%" value = "%PRODUCT_PERCENTAGE%" onchange="alter_add_product_observe(1,\'%PRODUCT_ID%\')"></td>',
            '<td><input id ="alter-product-no-id%PRODUCT_ID%-sale" type="number" min="0" class="alter-product-sale form-control" sorttable_customkey ="%PRODUCT_SALE%" value = "%PRODUCT_SALE%" onchange="alter_add_product_observe(2,\'%PRODUCT_ID%\')"></td>',
            '<td>%ACTION%</td>',
            '</tr>'
        ];
