    ...
    var ALTER_PRODUCT_ADD_NEW_PRODUCT_ROW=[
            ...
            '<td><input id ="alter-product-no-id%PRODUCT_ID%-unit" class="alter-product-unit form-control product-list" sorttable_customkey ="%PRODUCT_UNIT_NAME%" value = "%PRODUCT_UNIT_NAME%" onchange="alter_product_observe(4,\'%PRODUCT_ID%\')"></td>',
